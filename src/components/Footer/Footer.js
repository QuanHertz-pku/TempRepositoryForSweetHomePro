  ...
  return (
    <footer className="footer">
      <Container>
        <Row>
          <Col md="3">
            <h1 className="title">Sweet•Home</h1>
          </Col>
          <Col md="3">
            <Nav>
              <NavItem>
